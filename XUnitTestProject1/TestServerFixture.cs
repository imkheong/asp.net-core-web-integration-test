...
namespace XUnitTestProject1
{
    public class TestServerFixture : IDisposable
    {
        ...
        private string GetContentRootPath() => Path.Combine(PlatformServices.Default.Application.ApplicationBasePath, @"..\WebApplication1\");

        private string ExtractAntiForgeryCookieValueFrom(System.Net.Http.HttpResponseMessage response)
        {
